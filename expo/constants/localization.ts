...
const translations: Record<Language, TranslationTree> = {
  en: {
    ...
    dashboard: {
      ...
      cropSingular: 'crop',
      cropPlural: 'crops',
      addFirstCropPrompt: 'Welcome to AISmartKheti, {{name}}!',
      active: 'Active',
      ...
      overdueBy: 'Overdue {{count}}d',
      expectedHarvest: 'Expected: {{date}} ({{days}}d)',
      expectedHarvestOverdue: 'Expected: {{date}} (Overdue {{count}}d)',
    ...
    activitiesScreen: {
      ...
      deleteActivityMessage: 'Delete "{{title}}"?',
    ...
    cropDetail: {
      ...
      harvestDate: 'Harvest',
      deleteActivityTitle: 'Delete Activity',
      deleteActivityMessage: 'Are you sure you want to delete this activity?',
      longPressHint: 'Long press to delete',
      cancel: 'Cancel',
      delete: 'Delete',
    },
  ...
  hi: {
    ...
    dashboard: {
      ...
      cropSingular: 'फसल',
      cropPlural: 'फसलें',
      addFirstCropPrompt: 'AISmartKheti में आपका स्वागत है, {{name}}!',
      active: 'सक्रिय',
      ...
      overdueBy: '{{count}} दिन विलंब',
      expectedHarvest: 'अनुमानित: {{date}} ({{days}} दिन)',
      expectedHarvestOverdue: 'अनुमानित: {{date}} ({{count}} दिन विलंब)',
    ...
    activitiesScreen: {
      ...
      deleteActivityMessage: '"{{title}}" हटाएँ?',
      longPressHint: 'हटाने के लिए देर तक दबाएँ',
      cancel: 'रद्द करें',
      delete: 'हटाएँ',
    },
    cropDetail: {
      ...
      harvestDate: 'कटाई',
      deleteActivityTitle: 'गतिविधि हटाएँ',
      deleteActivityMessage: 'क्या आप इस गतिविधि को हटाना चाहते हैं?',
      longPressHint: 'हटाने के लिए देर तक दबाएँ',
      cancel: 'रद्द करें',
      delete: 'हटाएँ',
    },
